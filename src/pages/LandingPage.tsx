    ...
    <main id="main-content">
      <section className="landing-hero">
        ...
        <div className="hero-visual" aria-label="CampusFit demand preview">
          ...
          <div className="phone-frame"><div className="phone-speaker" /><div className="mini-brand"><Brand /><span>Today</span></div><p className="mini-kicker">YOUR BEST MOVE</p><h2>Paulson at 7:30</h2><p className="mini-copy">Lighter cable demand could save you 18–24 minutes.</p><div className="mini-demand"><div><span className="pulse-dot" /><strong>Moderate</strong><small>overall demand</small></div><div><strong>12</strong><small>CampusFit users</small></div></div><div className="mini-equipment"><span>Cable stations</span><b>Low wait</b><i style={{ width: '36%' }} /></div><div className="mini-equipment"><span>Row machines</span><b>Moderate</b><i style={{ width: '61%' }} /></div><button>Plan this workout <ArrowRight size={15} /></button></div>
