...
export function LoginPage({ audience }: { audience: 'student' | 'staff' }) {
  ...
  return <main id="main-content" className={`login-page ${staffPortal ? 'login-page--staff' : ''}`} style={{ '--tenant-primary': university.primaryColor, '--tenant-secondary': university.secondaryColor, '--tenant-accent': university.accentColor } as React.CSSProperties}>
