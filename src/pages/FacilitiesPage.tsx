...
export function FacilitiesPage() {
  ...
  return <div className="page-stack facilities-page">
    ...
    <section className="gym-comparison-list" aria-label="Ranked NYU gyms">{recommendations.map((recommendation, index) => <GymRecommendationCard key={recommendation.facility.id} state={state} tenant={tenant} recommendation={recommendation} index={index} />)}</section>
