...
export function PlanPage() {
  ...
  const timeSlots = [...new Set(quickTimes)].map((item) => {
    ...
    const slotRecommendations = recommendFacilities(state, slotArrival, visitIntent === 'workout' ? selectedFocuses : undefined, activity || undefined, duration, selectedEquipment);
